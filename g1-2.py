...
#for gamma in [0.05,0.1,0.3,0.5,0.8,1.,1.4] :
  #dat_i=str(i)+".dat"
  #comando = "./abc -o purity -q 17 --x 6 --model modelConexRandABC --Jc 0.01 --Jp "+str(gamma)+" --Js 1. --DJs 0. --bx 1. --bz 1. --Dbs -2 --t 2500 --Cseed -1 --Eseed 3462 --PARAMseed 9678  > grafica1-6-"
