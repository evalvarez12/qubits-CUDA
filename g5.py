...
#for i in [[6,10],[8,10],[10,10]] :
  #dat_i=str(j)+".dat"
  #comando = "./abc -o purity_gamma -q "+str(i[0]+i[1]+1)+" --x "+str(i[0])+" --model modelVar14 --Jc 0.01 --Jp 1 --Js 1. --DJs 0. --bx 1. --bz 1. --Dbs 0. --t 1000 --Cseed -1 --Eseed 3462 --PARAMseed 9678  > grafica5-5-"
  #os.system(comando + dat_i)
  #j+=1
