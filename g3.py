...
#for lamb in log10(logspace(0,0.1,100)) :
  #dat_i=".dat"
  #comando = "./abc -o purity_onet -q 17 --x 6 --model modelConexComplete --Jc "+str(lamb)+" --Jp 0.5 --Js 1. --DJs 0. --bx 1. --bz 1. --Dbs 0. --t 1000 --Cseed -1 --Eseed 3462 --PARAMseed 9678  >> grafica3-complete-gamma_0.5"
  #os.system(comando + dat_i)
  #print lamb

#for lamb in log10(logspace(0,0.1,100)) :
  #dat_i=".dat"
  #comando = "./abc -o purity_onet -q 17 --x 6 --model modelConexComplete --Jc "+str(lamb)+" --Jp 0.1 --Js 1. --DJs 0. --bx 1. --bz 1. --Dbs 0. --t 1000 --Cseed -1 --Eseed 3462 --PARAMseed 9678  >> grafica3-complete-gamma_0.1"
  #os.system(comando + dat_i)
  #print lamb
  
#for lamb in log10(logspace(0,0.1,100)) :
  #dat_i=".dat"
  #comando = "./abc -o purity_onet -q 17 --x 6 --model modelConexComplete --Jc "+str(lamb)+" --Jp 0.01 --Js 1. --DJs 0. --bx 1. --bz 1. --Dbs 0. --t 1000 --Cseed -1 --Eseed 3462 --PARAMseed 9678  >> grafica3-complete-gamma_0.01"
  #os.system(comando + dat_i)
  #print lamb
